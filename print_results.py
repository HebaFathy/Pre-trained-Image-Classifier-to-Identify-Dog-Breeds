...
def print_results(results_dic, results_stats_dic, model, 
    ...
    #print("{:20}: {:3f}".format('Correct_Dogsr%', results_stats_dic['pct_correct_dogs']))
    #print("{:20}: {:3f}".format('Correct_Breed'%, results_stats_dic['pct_correct_breed']))
    #print("{:20}: {:3f}".format('Correct_Not-Dog%', results_stats_dic['pct_correct_notdogs']))
    for key in results_stats_dic:
        #percentages in results_stats_dic have keys starting with p 
        if key[0] == "p":
